...
def database_sync(request: Request) -> dict[str, Any]:
    # Backward-compatible endpoint: the menu now means pull, not push.
    return database_pull(request)
