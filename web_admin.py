...
SETTING_SCHEMA: dict[str, dict[str, Any]] = {
    ...
    "credit_code_enabled": {"label": "กรอกโค้ดเครดิต", "type": "bool", "default": "1", "group": "TrueMoney"},
    "truemoney_enabled": {"label": "เติมเงิน TrueMoney", "type": "bool", "default": "1", "group": "TrueMoney"},
    ...
    "buy_dm_enabled": {"label": "ช่องทางการซื้อ: DM", "type": "bool", "default": "0", "group": "ซื้อ VPN"},
    "buy_group_enabled": {"label": "ช่องทางการซื้อ: กลุ่ม", "type": "bool", "default": "1", "group": "ซื้อ VPN"},
