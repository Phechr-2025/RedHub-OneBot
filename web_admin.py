...
SETTING_SCHEMA: dict[str, dict[str, Any]] = {
    ...
    "cancel_button_delay_seconds": {"label": "หน่วงปุ่มยกเลิก (วินาที)", "type": "number", "default": "2", "min": 0, "group": "การแสดงผล"},
