...
SETTING_SCHEMA: dict[str, dict[str, Any]] = {
    ...
    "run_start_finish_delay_seconds": {"label": "หน่วงเมนู /start (วินาที)", "type": "number", "default": "5", "min": 0.1, "group": "การแสดงผล"},
    "cancel_button_delay_seconds": {"label": "หน่วงปุ่มยกเลิก (วินาที)", "type": "number", "default": "0", "min": 0, "group": "การแสดงผล"},
    "run_start_finish_commands": {"label": "คำสั่งหลังจบให้เด้ง /start (คั่นด้วย ,)", "type": "text", "default": "addclient", "group": "การแสดงผล"},
