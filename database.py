...
def init_db():
    ...
    conn.execute("INSERT OR IGNORE INTO settings VALUES ('cancel_button_delay_seconds', '2')")
    ...
    conn.execute("UPDATE settings SET value='2' WHERE key='cancel_button_delay_seconds' AND value IN ('0','1')")
